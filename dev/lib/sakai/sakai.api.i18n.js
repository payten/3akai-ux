        ...
        init : function(meData){
            ...
            var finishI18N = function(){
                ...
                if (meData && meData.user && meData.user.anon) {                    
                    if ($.inArray(currentPage, sakai_config.requireUser) > -1 || (!sakai_config.anonAllowed && sakai_config.anonAllowable && $.inArray(currentPage, sakai_config.anonAllowable) === -1)) {
