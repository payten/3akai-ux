...
define(["config/config"], function(config) {
    ...
    */
     ...
     */
    config.NYUTagList = [
        {value: "Advanced Global Cultures (GLS)"},
        {value: "African Cultures"},
        {value: "Africana Studies"},
        {value: "Approaches Seminar (GLS)"},
        {value: "Area Studies"},
        {value: "Art History"},
        {value: "Arts and Social Change"},
        {value: "Arts and Literatures (GLS)"},
        {value: "Business"},
        {value: "Communications"},
        {value: "Community Studies"},
        {value: "Contemporary Culture and Creative Production (GLS)"},
        {value: "Core"},
        {value: "Cultural Foundations (Core/GLS)"},
        {value: "Cultural Studies"},
        {value: "Creative Writing"},
        {value: "Dance"},
        {value: "Dean’s Circle (Core/GLS)"},
        ...
        {value: "Global Liberal Studies"},
        {value: "Global Studies (Core/GLS)"},
        {value: "Global Topics (GLS)"},
        {value: "Globalization"},
        {value: "GLS"},
        {value: "Histories, Philosophies, and Worldviews (GLS)"},
        {value: "History"},
        {value: "History of the Universe (Core/GLS)"},
        {value: "Humanities"},
        {value: "Identities and Representations (GLS)"},
        {value: "Internship"},
        {value: "Journalism"},
        {value: "Junior Independent Research Seminar (GLS)"},
        {value: "Latin American Cultures"},
        ...
        {value: "Philosophy"},
        {value: "Politics"},
        {value: "Politics, Rights, and Development (GLS)"},
        {value: "Public Health"},
        {value: "Religion"},
        {value: "Science, Technology, and Society (GLS)"},
        {value: "Science of Technology (Core/GLS)"},
        {value: "Senior Capstone Seminar (GLS)"},
        {value: "Senior Colloquium (GLS)"},
        {value: "Senior Thesis"},
        {value: "Social Entrepreneurship"},
        {value: "Social Foundations  (Core/GLS)"},
        {value: "South Asian Studies"},
        {value: "South Asian Cultures"},
        {value: "Studio Arts"},
        {value: "Television"},
        {value: "Theater Arts"},
        {value: "Theology"},
