...
require(["jquery", "sakai/sakai.api.core"], function($, sakai) {
    ...
    sakai_global.footer = function(tuid,showSettings){
        ...
        var $footer_links_template = $("#footer_links_template");
        ...
        var doInit = function(){
            ...
            var leftLinksHTML = sakai.api.Util.TemplateRenderer($footer_links_template, {links:sakai.config.Footer.leftLinks});
            leftLinksHTML = sakai.api.i18n.General.process(leftLinksHTML);
            $footer_links.html(leftLinksHTML);

            var rightLinksHTML = sakai.api.Util.TemplateRenderer($footer_links_right_template, {links:sakai.config.Footer.rightLinks});
            rightLinksHTML = sakai.api.i18n.General.process(rightLinksHTML);
