...
require(["jquery", "sakai/sakai.api.core", "underscore"], function($, sakai, _){
    ...
    sakai_global.addarea = function(tuid, showSettings){
        ...
        var resetContentList = function(){
            ...
            $(".nyumylibrary-config .nyu-version-options input").attr("disabled","disabled");
        };
        ...
        var resetParticipantsList = function(){
            ...
            $("#addarea_participants_nyuversion_richdetails").removeAttr("checked");
            $("#addarea_participants_nyuversion_tagcloud").removeAttr("checked");
        };
        ...
        var createContentLibrary = function() {
            ...
            var widgetToCreate = useNYUWidget?"nyumylibrary":"mylibrary";
            ...
            docStructure[0][widgetID][widgetToCreate] = {
